...
<body>
    <header>
        ...
        <?php
            ...
            <a href="category.php"><input type="button" value="카테고리"></a> &nbsp;
            <br><br>
        </form>
    </header>
    <table>
        ...
        $find = "SELECT * FROM product A , category B, user C  WHERE B.category = A.category AND A.userid = '$userid' AND C.userid = A.userid AND A.category = '$category' ORDER BY expireddate ASC;;";
